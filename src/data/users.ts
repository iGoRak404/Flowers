...
export const USERS_CONFIG: UserConfig[] = [
  {
    ...
    roleDescription: 'Efecto Leslie: Ramo radiante con destellos dorados y luciérnagas',
    avatarSeed: '💐'
  },
  {
    username: 'ashlie',
  ...
  },
  {
    ...
    roleDescription: 'Animación: Vórtice Galáctico de Flores Doradas con canción Youth (Lee Know)',
    avatarSeed: '🌼'
  },
  {
    username: 'nata',
